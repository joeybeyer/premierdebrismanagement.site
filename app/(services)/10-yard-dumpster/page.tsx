...
const size = getSizeBySlug('10-yard-dumpster')!
const otherSizes = getOtherSizes('10')

export const metadata: Metadata = {
  title: '10 Yard Dumpster Rental | Pricing, Dimensions & Uses',
  description: `Rent a 10 yard dumpster for ${formatPrice(size)}. Perfect for garage cleanouts, small bathroom remodels, and deck removal. ${size.dimensions}. Same-day delivery available.`,
}
...
export default function TenYardDumpsterPage() {
  return (
    <>
      ...
      <Schema data={generateFAQSchema(SIZE_SPECIFIC_FAQS['10'])} />

      <div className="bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Breadcrumbs items={[{ name: '10 Yard Dumpster', href: '/10-yard-dumpster/' }]} />
        </div>
      </div>
          ...
          <div className="max-w-3xl">
            ...
            <KeyTakeaways
              items={[
                ...
                `Ideal for: garage cleanouts, small bathroom remodels, deck removal`,
            ...
            <div className="prose-content mb-8">
              <p>
                A 10-yard dumpster from{' '}
                <Link href="/" className="text-amber-600 hover:text-amber-700">
                  Premier Debris Management
                </Link>{' '}
                is our most compact roll-off container, perfect for small residential projects.
                At just 3.5 feet tall, it fits easily in most driveways without blocking garage access.
                This makes it ideal for homeowners tackling weekend cleanout projects or small renovations.
              </p>
              <p>
                If your project generates more debris than expected, consider upgrading to a{' '}
                <Link href="/20-yard-dumpster/" className="text-amber-600 hover:text-amber-700">
                  20-yard dumpster
                </Link>{' '}
                for medium renovations or a{' '}
            ...
            <div className="bg-slate-50 rounded-xl p-6 mb-12">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                  <p className="text-slate-500 text-sm">10 Yard Dumpster Rental</p>
      ...
      <FAQ faqs={SIZE_SPECIFIC_FAQS['10']} title="10 Yard Dumpster FAQs" />
      <CTA />
    </>
  )
}
